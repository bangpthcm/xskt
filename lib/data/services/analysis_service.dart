...
class AnalysisService {
  ...
  static ({double w1, double w2, double w3}) _getWeights(String mienScope) {
    ...
    // 1. Nam
    if (s.contains('nam')) {
      return (w1: 3.674811018, w2: 2.629254619, w3: 2.856368985);
    }
    // 2. Trung
    if (s.contains('trung')) {
      return (w1: 2.550457945, w2: 2.550457945, w3: 2.329902326);
    }
    // 3. Bắc
    if (s.contains('bắc') || s.contains('bac')) {
      return (w1: 11.73850857, w2: 10.445513, w3: 0.060127351);
    }
    ...
    return (w1: 11.73672132, w2: 11.59065385, w3: 2.304901226);
  }
