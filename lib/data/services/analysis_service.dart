...
class AnalysisService {
  ...
  static ({double w1, double w2, double w3}) _getWeights(String mienScope) {
    ...
    // 1. Nam
    if (s.contains('nam')) {
      return (w1: 2.621141366, w2: 1.87729605, w3: 2.03951632);
    }
    // 2. Trung
    if (s.contains('trung')) {
      return (w1: 2.667067374, w2: 2.667067374, w3: 2.436220056);
    }
    // 3. Bắc
    if (s.contains('bắc') || s.contains('bac')) {
      return (w1: 2.415612137, w2: 2.415612137, w3: 2.393928838);
    }
    ...
    return (w1: 9.656681592, w2: 9.539706339, w3: 1.895583791);
  }
